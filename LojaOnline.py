...
if choice == ' O Mundo de Patty':
    ...
    with col1:
        ...
        st.write("O Mundo de Patty vai surprender os seus filhos com maravilhosas histórias sobre adolescentes e a vida num colegio onde tudo pode Acontecer. Patty e os seus amigos vão entrar num grande de dasfio que é a escola meterem-se em aventuras musicais. Venha conhecer o Mundo de PATTY")
